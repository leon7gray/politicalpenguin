        ...
        switch (activeComponent) {
            case 'ensembleData':
                return <div className = 'init-data'>
                             <EnsembleDataTable clustersData={dummyData['Florida']} />
                        </div>;
            case 'clusterSummary':
                return <div className = 'init-data'>
                            <ClusterSummaryTable clustersData={dummyData['Florida']} />
                        </div>;
            case 'scatterPlot':
                return <div className = 'init-data'>
                            <ScatterPlot clustersData={dummyData['Florida']} />
                        </div>;
            ...
            case 'stateInfo':
                return (
                    <div>
                        <h4>State Summary for Florida</h4>
                        <div>
